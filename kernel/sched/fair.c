...
unsigned int __read_mostly sysctl_sched_small_task_pct = 38;
...
unsigned int sysctl_sched_upmigrate_pct = 88;
...
unsigned int sysctl_sched_downmigrate_pct = 70;

/*
 * Tasks whose nice value is > sysctl_sched_upmigrate_min_nice are never
 * considered as "big" tasks.
 */
static int __read_mostly sched_upmigrate_min_nice = 12;
int __read_mostly sysctl_sched_upmigrate_min_nice = 12;
